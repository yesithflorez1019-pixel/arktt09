    ...
    <div className="animate-fade-in pt-12 pb-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Columna Derecha: Proceso y Formulario */}
          <div className="space-y-8">
            
            <TarjetaCristal className="p-8">
              <h3 className="text-xl font-bold text-slate-800 mb-6">Pasos para la Matrícula</h3>
              <div className="space-y-6">
                {[
                  { num: "01", titulo: "Adquirir Formulario", desc: "Solicítalo en la secretaría del colegio." },
                  { num: "02", titulo: "Entrevista / Examen", desc: "Se agendará una cita con psicología o coordinación." },
                  { num: "03", titulo: "Entrega de Documentos", desc: "Radicar la carpeta completa en las fechas estipuladas." },
                  { num: "04", titulo: "Pago de Matrícula", desc: "Realizar el pago de costos educativos." },
                  { num: "05", titulo: "Firma de Matrícula", desc: "Padres y estudiante formalizan el ingreso." }
                ].map((paso, i) => (
                  <div key={i} className="flex gap-4">
                    <div className="text-3xl font-extrabold text-slate-200">{paso.num}</div>
                    <div>
                      <h4 className="font-bold text-slate-700">{paso.titulo}</h4>
            ...
            <button className="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-4 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2">
              <Download size={20} /> Descargar Formulario de Inscripción
            </button>
